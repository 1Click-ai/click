...
export async function generateMetadata({ params }): Promise<Metadata> {
  ...
  const fallbackMetaData = {
    title: 'Shared Conversation | КЛИК',
    description: 'Replay this Agent conversation on КЛИК',
    alternates: {
  ...
  try {
    ...
    const title = projectData.name || 'Shared Conversation | КЛИК';
    const description =
      projectData.description ||
      'Replay this Agent conversation on КЛИК';
